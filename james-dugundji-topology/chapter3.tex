...
Let \( \left\{ A_{\alpha} \mid \alpha \in \mathscr{A} \right\} \) be any family of sets in \(X\). Assue that \( \bigcup_{\alpha} \overline{A_{\alpha}} \) is closed. Prove \( \bigcup_{\alpha} \overline{A_{\alpha}} = \overline{\bigcup_{\alpha} A_{\alpha}} \).
\end{problem}
