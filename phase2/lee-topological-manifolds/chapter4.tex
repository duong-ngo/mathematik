...
\begin{proof}
	...
	If $X$ is a complete metric space then so is $A$ with the subspace topology. If is locally compact Hausdorff then so is $A$ with the subspace topology, according to Proposition 4.66. So $A$ is a complete metric space or a locally compact Hausdorff space.
