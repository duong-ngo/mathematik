...
Denote the set of all Dedekind cuts of $\mathbb{Q}$ by $\mathfrak{C}_{\mathbb{Q}}$.

\begin{theorem}[Totally ordered]
    $\mathfrak{C}_{\mathbb{Q}}$ is totally ordered with $\subseteq$ relation.
\end{theorem}
...
Another way to construct the real numbers from the rational numbers is using Cauchy sequences. The content of this section is a complete version of Todd Kemp's note --- \textit{Cauchy's construction of $\mathbb{R}$}.
...
At this point, we have proved that the set of all Cauchy sequences (with only rational terms) satisfies the field axioms.
