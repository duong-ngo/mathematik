...
Let's just get to the point. What are the real numbers?
...
It follows from the definition that $\mathbb{Q}\setminus A$ contains all (rational) upper bounds of $A$.
...
Unlike addition, we cannot define subtraction in the element-wise style. I recommend readers to verify this with rational cuts/rational numbers.
...
\begin{proof}
    \begin{enumerate}[label={(\roman*)}]
        ...
        \item Let $a_{0}\in\mathbb{Q}\setminus A, b_{0}\in B, a\in A, b\in\mathbb{Q}\setminus B$. Then $a < a_{0}$ and $b_{0} < b$.
              \[
...
\begin{proof}
    ...
    \begin{enumerate}[label = (F\arabic*)]
        ...
        \item Addition has identity element.
              ...
              \begin{enumerate}[label={\textbf{Step \arabic*.}}]
                  ...
                  \item Prove that $A + {0}^{*} \subseteq A$.
                        ...
                        Let $a_{0}\in A + {0^{*}}$. According to the definition of $A + {0}^{*}$, there exists $a\in A$ and $w\in\mathbb{Q}_{-}$ such that $a_{0} = a + w$.
        ...
        \item Every element has an additive inverse.
              \begin{align*}
                  A + (-A) & = \{ a + (w - a') : a\in A\land w\in\mathbb{Q}_{-}\land a'\in\mathbb{Q}\setminus A \} \\
                           & = \{ (w - a') + a : a\in A\land w\in\mathbb{Q}_{-}\land a'\in\mathbb{Q}\setminus A \} \\
                           & = (-A) + A.
              \end{align*}
...
\begin{definition}[Preorder relations]
    Let $\seq{a_{n}}$ and $\seq{b_{n}}$ be two Cauchy sequences.
...
% need more explanation on this choice of definition
