...
Denote the set of all Dedekind cuts of $\mathbb{Q}$ by $\mathfrak{D}_{\mathbb{Q}}$.

\begin{theorem}[Totally ordered]
    $\mathfrak{D}_{\mathbb{Q}}$ is totally ordered with $\subseteq$ relation.
\end{theorem}
...
We define the relation $\le$ on $\mathfrak{D}_{\mathbb{Q}}$ as follow:
\[
...
I need the following property to verify the group structure of $\mathfrak{D}_{\mathbb{Q}}$.
...
\begin{theorem}\label{theorem:chapter1:real-field-part-one}
    $\mathfrak{D}_{\mathbb{Q}}$ with addition is a commutative group.
...
\begin{theorem}
    In $\mathfrak{D}_{\mathbb{Q}}$, addition is compatible with $\subseteq$
    \[
        \forall A, B, C\in\mathfrak{D}_{\mathbb{Q}}(A\subseteq B \rightarrow A + C\subseteq B + C).
    \]
\end{theorem}
...
\begin{theorem}\label{theorem:chapter1:multiplication-and-order}
    Multiplication in $\mathfrak{D}_{\mathbb{Q}}$ is compatible with $\subseteq$.
    \[
        \forall A, B\in\mathfrak{D}_{\mathbb{Q}}(A\supseteq {0}^{*}\land B\supseteq {0}^{*}\rightarrow A\cdot B\supseteq {0}^{*}).
    \]
\end{theorem}
...
\begin{theorem}
    $\mathfrak{D}_{\mathbb{Q}}$ with addition and multiplication is a commutative ring.
\end{theorem}
...
\begin{proof}
    ...
    \begin{enumerate}[label={(F\arabic*)}, start=5]
        ...
        \item Multiplication is commutative.
              ...
              Thus, multiplication in $\mathfrak{D}_{\mathbb{Q}}$ is commutative.
    \end{enumerate}
\end{proof}
...
(F1) (F2) (F3) (F4) (F5) (F6) (F7) (F8) make $\mathfrak{D}_{\mathbb{Q}}$ a commutative ring. Together with the following, $\mathfrak{D}_{\mathbb{Q}}$ is a field.

\begin{theorem}\label{theorem:chapter1:multiplicative-inverse}
    \begin{enumerate}[label={(F\arabic*)},start=9]
        \item Each non-zero element of $\mathfrak{D}_{\mathbb{Q}}$ has a multiplicative inverse.
    \end{enumerate}
\end{theorem}

\begin{proof}
    Let $A$ be a non-zero element of $\mathfrak{D}_{\mathbb{Q}}$. I will show that
    \[
        A\cdot ({1}^{*}/A) = ({1}^{*}/A)\cdot A = {1}^{*}.
    \]

    Since multiplication over $\mathfrak{D}_{\mathbb{Q}}$ is commutative, then $A\cdot ({1}^{*}/A) = ({1}^{*}/A)\cdot A$.
...
\begin{theorem}
    $\mathfrak{D}_{\mathbb{Q}}$ is a field and it is characteristic zero.
\end{theorem}

\begin{proof}
    (F1) (F2) (F3) (F4) (F5) (F6) (F7) (F8) (F9) together assert that $\mathfrak{D}_{\mathbb{Q}}$ is a field.

    Since ${0}^{*} < {1}^{*}$, then for all positive integer $n$
    \[
        \underbrace{{1}^{*} + \cdots + {1}^{*}}_{n} > {0}^{*}.
    \]
    Therefore, $\mathfrak{D}_{\mathbb{Q}}$ is characteristic zero.
\end{proof}

\subsection{Least-upper-bound property}

So far, we prove that the set of Dedekind cuts with addition and multiplication is a totally ordered field. But those properties make no distinction between $\mathfrak{D}_{\mathbb{Q}}$ and $\mathbb{Q}$. The property that makes distinction is the least-upper-bound property.
...
Now we have proved that $\mathfrak{D}_{\mathbb{Q}}$ satisfies all real numbers axioms.

\subsection{Embed $\mathbb{Q}$ into $\mathfrak{D}_{\mathbb{Q}}$}

I don't feel so good after proving that $\mathfrak{D}_{\mathbb{Q}}$ is a totally ordered field. It is because I haven't showed that the addition and multiplication in $\mathfrak{D}_{\mathbb{Q}}$ are ``the same'' as addition and multiplication $\mathbb{Q}$.

\begin{theorem}
    There exists a ring monomorphism $\iota$
    \[
        \begin{split}
            \iota:\quad & \mathbb{Q}\to\mathfrak{D}_{\mathbb{Q}}, \\
            & q\mapsto {q}^{*}
        \end{split}
    \]
...
\begin{proof}
    ...
    We have constructed a ring monomorphism $\iota:\mathbb{Q}\to\mathfrak{D}_{\mathbb{Q}}$ that preserves order.
\end{proof}
...
Another way to construct the real numbers from the rational numbers is using Cauchy sequences. The content of this section is a complete version (nothing is left as an exercise) of Todd Kemp's note $-$ \textit{Cauchy's construction of $\mathbb{R}$}.
...
Let's denote the set of all equivalance classes of Cauchy sequences (with only rational terms) by $\mathfrak{C}_{\mathbb{Q}}$, just like in Todd Kemp's note.

\subsection{Field structure}

In this subsection, we will define addition and multiplication over Cauchy sequences and classes of Cauchy sequences. Then we will prove that $\mathfrak{C}_{\mathbb{Q}}$ is a field.
...
\begin{definition}
    $\alpha, \beta\in\mathfrak{C}_{\mathbb{Q}}$.
...
\begin{theorem}
    $\mathfrak{C}_{\mathbb{Q}}$ with addition is a commutative group.
...
\begin{theorem}[Product of Cauchy sequences]\label{theorem:chapter1:product-of-cauchy-sequences}
    Let $\seq{a_{n}}, \seq{b_{n}}\in\mathfrak{C}_{\mathbb{Q}}$, then $\seq{c_{n}}$ where $c_{n} = a_{n} \cdot b_{n}$ is a Cauchy sequence.
\end{theorem}
...
\begin{theorem}
    $\mathfrak{C}_{\mathbb{Q}}$ with addition and multiplication is a commutative ring.
...
\begin{proof}
    ...
    I have difficulty constructing such a sequence/class of sequences. So I need the following lemma.
    ...
    \begin{lemma}\label{lemma:chapter1:nonzero-sequence}
        ...
        \begin{itemize}[itemsep=0pt]
            \item $(\exists N)(\forall n > N)(a_{n} > 0)$,
            \item $(\exists N)(\forall n > N)(a_{n} < 0)$.
        \end{itemize}

        Combine the two, we obtain a weaker result: $(\exists N)(\forall n > N)(a_{n}\ne 0)$.
    \end{lemma}

    \begin{proof}[Proof of Lemma~\ref{lemma:chapter1:nonzero-sequence}]
        $\seq{a_{n}}$ is a Cauchy sequence, so
        \[
            (\exists N_{0}=N_{0}(\varepsilon))(\forall m, n > N_{0})(\abs{a_{m} - a_{n}} < \varepsilon_{0})
        \]

        Since $\seq{a_{n}}$ and $\seq{0}$ are inequivalent, then there exists a positive rational number $\varepsilon_{0}$ such that
        \[
            (\forall N_{1})(\exists n_{0} > N_{1})\left(\abs{a_{n_{0}}}\ge\varepsilon_{0}\right) \implies (\exists n_{0} > N_{0})\left(\abs{a_{n_{0}}}\ge\varepsilon_{0}\right)
        \]

        So, for all $n > N_{0}$
        \[
            -\varepsilon_{0} < a_{n} - a_{n_{0}} < \varepsilon_{0}.
        \]

        $\abs{a_{n_{0}}}\ge\varepsilon_{0}$ implies that $a_{n_{0}}\ge\varepsilon_{0}$ or $a_{n_{0}}\le-\varepsilon_{0}$.
        \bigskip
        ...
        For all $n > N_{0}$
        \[
            a_{n} = (a_{n} - a_{n_{0}}) + a_{n_{0}} > -\varepsilon_{0} + \varepsilon_{0} > 0.
        \]
    ...
    \textbf{Back to the theorem's proof.}

    Since $\seq{a_{n}}$ and $\seq{0}$ are inequivalent, there exists a natural number $N$ such that for all $n > N$, $a_{n}\ne 0$.
...
\subsection{Total ordering and compatibility with addtion and multiplication}

In this subsection, we aim to define order relation in $\mathfrak{C}_{\mathbb{Q}}$ and show that the order relation satisfies the axioms of the real numbers.

However, like addition and multiplication, we will define an order relation (actually, preorder relation) between Cauchy sequences.
...
\begin{theorem}
    The ``$\le$'' relation amongst Cauchy sequences is a total \textbf{preorder} relation.
\end{theorem}
...
\begin{proof}
    \begin{itemize}
        \item Reflexivity.
              ...
              Due the definition, a Cauchy sequence precedes itself.
        \item Transitivity.

              Assume that $\seq{a_{n}}\le\seq{b_{n}}$ and $\seq{b_{n}}\le\seq{c_{n}}$.

              According to the definition of ``$\le$'' relation
              \[
                  \begin{split}
...
The ``$\le$'' relation between Cauchy sequences is not anti-symmetric. Instead, we have the following result.
...
\begin{proof}
    \[
        \begin{split}
            \seq{a_{n}}\le\seq{b_{n}} \implies (\exists N_{1})(\forall n > N_{1})(a_{n}\le b_{n}), \\
            \seq{b_{n}}\le\seq{a_{n}} \implies (\exists N_{2})(\forall n > N_{2})(b_{n}\le a_{n}).
        \end{split}
    \]

    Let $N = \max\{ N_{1}, N_{2} \}$.
    \[
        (\forall n > N)(a_{n}\le b_{n} \land b_{n}\le a_{n}) \Longleftrightarrow (\forall n > N)(a_{n} = b_{n}).
    \]

    Therefore
    \[
        (\forall\varepsilon > 0)(\forall n > N)(\abs{a_{n} - b_{n}} = 0 < \varepsilon).
    \]
...
The following theorem is the key to allow us to define an \textbf{order} relation (yes, order, not preorder) in $\mathfrak{C}_{\mathbb{Q}}$.

\begin{theorem}\label{theorem:chapter1:equivalent-cauchy-sequences-and-order}
    $\seq{a_{n}}, \seq{b_{n}}\in\mathfrak{C}_{\mathbb{Q}}$ such that $\seq{a_{n}}\le\seq{b_{n}}$.

    $\seq{a_{n}}$ and $\seq{c_{n}}$ are equivalent, $\seq{b_{n}}$ and $\seq{d_{n}}$ are equivalent.

    Then $\seq{c_{n}}\le\seq{d_{n}}$.
\end{theorem}

\begin{proof}
    We consider the two following cases.

    \textbf{Case 1. $\seq{a_{n}}$ and $\seq{b_{n}}$ are equivalent.}
    ...
    \textbf{Case 2. $\seq{a_{n}}$ and $\seq{b_{n}}$ are inequivalent.}

    According to the definition of equivalent Cauchy sequences
    \[
        (\exists\varepsilon > 0)(\forall N)(\exists n > N)(\abs{a_{n} - b_{n} - 0}\ge\varepsilon).
    \]

    Therefore, $\seq{a_{n} - b_{n}}$ does not converge to $0$. $\seq{0}$ converges to $0$, so $\seq{a_{n} - b_{n}}$ and $\seq{0}$ are inequivalent.
    ...
    \[
        (\exists N_{c})(\forall n > N_{c})\left(\abs{c_{n} - a_{n}} < \frac{b_{N_{3}+1} - a_{N_{3}+1}}{8}\right).
    \]

    $\seq{b_{n}}$ and $\seq{d_{n}}$ are equivalent, so
    \[
        (\exists N_{d})(\forall n > N_{d})\left(\abs{b_{n} - d_{n}} < \frac{b_{N_{3}+1} - a_{N_{3}+1}}{8}\right).
    \]
    ...
    In conclusion, $\seq{c_{n}}\le\seq{d_{n}}$.
\end{proof}

\begin{definition}
    We say $\class{\seq{a_{n}}}$ precedes $\class{\seq{b_{n}}}$ if and only if every Cauchy sequence in $\class{\seq{a_{n}}}$ precedes every Cauchy sequence in $\class{\seq{b_{n}}}$, and denote this relation by $\class{\seq{a_{n}}}\le\class{\seq{b_{n}}}$.
\end{definition}

\begin{theorem}[Total order]
    $\mathfrak{C}_{\mathbb{Q}}$ with ``$\le$'' relation is totally ordered.
\end{theorem}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item Transitivity ($\alpha\le\beta\land\beta\land\gamma\rightarrow\alpha\le\gamma$).
              ...
              According to the definition of ``$\le$'' in $\mathfrak{C}_{\mathbb{Q}}$, $\seq{a_{n}}\le\seq{b_{n}}$ and $\seq{b_{n}}\le\seq{c_{n}}$.
        ...
        \item Anti-symmetry ($\alpha\le\beta\land\beta\le\alpha\rightarrow\alpha=\beta$).
              ...
              According to the definition of ``$\le$'' in $\mathfrak{C}_{\mathbb{Q}}$, $\seq{a_{n}}\le\seq{b_{n}}$ and $\seq{b_{n}}\le\seq{a_{n}}$.
...
\begin{theorem}
    Let $\alpha, \beta, \gamma\in\mathfrak{C}_{\mathbb{Q}}$.
    \begin{enumerate}[label={(\roman*)}]
...
\subsection{Embed $\mathbb{Q}$ into $\mathfrak{C}_{\mathbb{Q}}$}
