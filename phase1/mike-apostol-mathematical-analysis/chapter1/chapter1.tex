...
\begin{proof}
    ...
    \begin{enumerate}[label={(F\arabic*)}, start=4]
        ...
        \item Multiplication is distributive over addition.
              ...
              \textbf{Prove that $(A + B)\cdot C\subseteq A\cdot C + B\cdot C$.}
              ...
              \textbf{Prove that $A\cdot C + B\cdot C\subseteq (A + B)\cdot C$.}
              ...
              \textbf{Case 8.} $C\subset {0}^{*}, A\supset {0}^{*}, B\supset {0}^{*}$.

              \textbf{Case 9.} $C\subset {0}^{*}, A\subset {0}^{*}, B\subset {0}^{*}$.

              \textbf{Case 10.} $C\subset {0}^{*}, A\supset {0}^{*}, B\subset {0}^{*}$.

              \textbf{Case 11.} $C\subset {0}^{*}, A\subset {0}^{*}, B\supset {0}^{*}$.
